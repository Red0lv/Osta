...
const ShipShoreChecklist = () => {
  const [language, setLanguage] = useState('lv'); // Default language is Latvian
        ...
        <div className="pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
              ...
              <div>
                ...
                <input type="text" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded" />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
              ...
              <input type="date" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded" />
            </div>
            
            <div>
              <label className="block text-sm text-gray-700">{texts.time}</label>
              <input type="time" className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded" />
            </div>
          </div>
        </div>
